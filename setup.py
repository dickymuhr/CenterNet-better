...
with open("tools/dl_count", "w") as dl_lib_count:
    dl_lib_count.write(
        head + f"python3 {os.path.join(cur_dir, 'tools', 'count_params.py')} $@")
...
setup(
    ...
    scripts=["tools/dl_train", "tools/dl_test","tools/dl_count"],
)
